...
<style scoped>
    ...
    .scene-version-content { margin-top:20px; }
    .scene-version-description { margin-top:10px; margin-bottom:10px; padding:10px 20px; background:#f0efaf; color:#000; border:1px solid #f0e1af; }
</style>
